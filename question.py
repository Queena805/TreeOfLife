...
question_bank = {
    1: [
        {
            'text': "Round 1, Question 1",
            'choices': ["YES", "NO", "MAYBE"],
            'answer': 1,
            'bobby': "assets/expression_excited.png"
        },
        {
            'text': "Round 1, Question 2",
            'choices': ["TRUE", "FALSE"],
            'answer': 0,
    ...
    2: [
        {
            'text': "Round 2, Question 1",
            'choices': ["APPLE", "BANANA", "ORANGE", "KIWI"],
            'answer': 3,
            'bobby': "assets/expression_excited.png"
        },
        {
            'text': "Round 2, Question 2",
            'choices': ["TRUE", "FALSE"],
            'answer': 0,
            'bobby': "assets/expression_anxiety.png"
        },
        {
            'text': "Round 2, Question 3",
            'choices': ["TRUE", "FALSE"],
            'answer': 0,
            'bobby': "assets/expression_anxiety.png"
        }
    ...
    3: [
        {
            'text': "Round 3, Question 1",
            'choices': ["YES", "NO", "MAYBE"],
            'answer': 1,
            'bobby': "assets/expression_excited.png"
        },
        {
            'text': "Round 3, Question 2",
